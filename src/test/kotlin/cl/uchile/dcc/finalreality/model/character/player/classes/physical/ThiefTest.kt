...
class ThiefTest : FunSpec({
    ...
    lateinit var testCharacter1: Thief
    lateinit var testCharacter2: Thief
    lateinit var testCharacter3: Thief
    ...
    beforeEach {
        ...
        testCharacter1 = Thief("TestThief", 15, 10, queue)
        testCharacter2 = Thief("TestThief", 15, 10, queue)
        testCharacter3 = Thief("TestThief2", 18, 11, queue)
    }
    ...
    context("Any Thief should:") {
        test("Have a string representation") {
            testCharacter1.toString() shouldBe "Thief { name: 'TestThief', maxHp: 15, defense: 10, currentHp: 15 }"
            testCharacter2.toString() shouldBe "Thief { name: 'TestThief', maxHp: 15, defense: 10, currentHp: 15 }"
            testCharacter3.toString() shouldBe "Thief { name: 'TestThief2', maxHp: 18, defense: 11, currentHp: 18 }"
        }
        test("Not be null") {
        ...
        test("Be able to attack other characters") {
            ...
            testCharacter1.equip(Knife("TestKnife", 11, 5))
