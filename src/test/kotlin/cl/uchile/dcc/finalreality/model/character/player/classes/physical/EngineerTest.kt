...
class EngineerTest : FunSpec({
    ...
    lateinit var testCharacter1: Engineer
    lateinit var testCharacter2: Engineer
    lateinit var testCharacter3: Engineer
    lateinit var thisFactory: EngineerTestingFactory
    ...
    beforeEach {
        ...
        thisFactory = EngineerTestingFactory(queue)
        ...
        testCharacter1 = Engineer("TestEngineer", 15, 10, queue)
        testCharacter2 = Engineer("TestEngineer", 15, 10, queue)
        testCharacter3 = Engineer("TestEngineer2", 18, 11, queue)
    }
    ...
    context("Any Engineer should:") {
        test("Have a string representation") {
            testCharacter1.toString() shouldBe "Engineer { name: 'TestEngineer', maxHp: 15, defense: 10, currentHp: 15 }"
            testCharacter2.toString() shouldBe "Engineer { name: 'TestEngineer', maxHp: 15, defense: 10, currentHp: 15 }"
            testCharacter3.toString() shouldBe "Engineer { name: 'TestEngineer2', maxHp: 18, defense: 11, currentHp: 18 }"
        }
        test("Not be null") {
        ...
        test("Be able to attack other characters") {
            ...
            testCharacter1.equip(Bow("TestBow", 11, 5))
