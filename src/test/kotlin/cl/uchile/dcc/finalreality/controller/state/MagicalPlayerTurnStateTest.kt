...
import cl.uchile.dcc.finalreality.controller.getMagicDamageAction
...
import cl.uchile.dcc.finalreality.controller.useMagicAction
...
class MagicalPlayerTurnStateTest : FunSpec({
    ...
    val thisQuestion = GameState::isMagicalPlayerTurn
    ...
    context("A MagicalPlayerTurnState should") {
